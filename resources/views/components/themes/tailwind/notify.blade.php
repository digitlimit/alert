<div class="digitlimit-alert-notify">
    <div
        ...
        x-init="
            $store.toasts = $data;
            createToast('Hello World', 'success', 2000);
        "
            ...
            >
                <div class="flex flex-col w-full">
                    <div class="flex items-center w-full px-1 my-2">
                        ...
                        <div class="self-start px-1">
                            <button type="button" class="pt-0 px-1" @click="destroyToast(index)">
                    ...
                    <progress
                        x-data="{ value : 0 }"
                        x-init="setInterval(() => { if(value == 100) clearInterval(); else value+=1 }, toast.timeOut / 100)" max="100"
                        :value="value"
